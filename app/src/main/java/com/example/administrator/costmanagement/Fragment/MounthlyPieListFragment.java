 ...
 */
public class MounthlyPieListFragment extends android.app.Fragment {
    private Float[] yData;
    private String[] xData;

    public MounthlyPieListFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_mounthly_pie_list, container, false);
        dailyCostTotals = new ArrayList<>();
        costInputManager = new CostInputManager(getActivity());
        costsInSpecificCategory = costInputManager.getReport(20);
        ...
        extraCostsInSpecificCategory = categaryManager.getAllExtaCost(20);
        Float totExtra = 0f;
