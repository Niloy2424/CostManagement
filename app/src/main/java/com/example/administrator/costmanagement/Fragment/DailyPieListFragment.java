 ...
 */
public class DailyPieListFragment extends android.app.Fragment {

    private Float[] yData;
    private String[]xData;
    public DailyPieListFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_daily_pie_list, container, false);
       ...
       /* if (categaries.isEmpty())
        ...
        costsInSpecificCategory =costInputManager.getReport(1);
