...
import com.example.administrator.costmanagement.Activity.ReportActivity;
 ...
 */
public class DailyListFragment extends android.app.Fragment {
    ...
    private ListView dailyreportLV;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        dailyreportLV= (ListView) view.findViewById(R.id.dailyReportLV);

        // Inflate the layout for this fragment
        manager=new CostInputManager(getActivity());
        salesAllReports=manager.getReport(1);
        ...
        else
        {
            ...
            dailyreportLV.setAdapter(adapter);
        }
