 ...
 */
public class WeeklyListFragment extends android.app.Fragment {


    public WeeklyListFragment() {
        // Required empty public constructor
    }
    private ListView weeklyReportLV;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        weeklyReportLV= (ListView) view.findViewById(R.id.weeklyReportLV);

        // Inflate the layout for this fragment
        manager=new CostInputManager(getActivity());
        salesAllReports=manager.getReport(7);
        ...
        else
        {
            ...
            weeklyReportLV.setAdapter(adapter);
        }
        return view;
    }
